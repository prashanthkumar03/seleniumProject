...
public class FireFoxBrowser_11street {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElementByXPath("/html/body/header/div[4]/div/div[2]/form/i").click(); //clear text*/
		//<div class="header-navigation">
		//Links count and what are they
	/*	List<WebElement>Links = driver.findElements(By.tagName("a"));
		
		int LinksCount=Links.size();
		System.out.println("Links Counts in home page is : " +LinksCount);
